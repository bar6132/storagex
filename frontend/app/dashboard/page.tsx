    ...
    <div className="min-h-screen bg-white text-black">
      ...
      <div className="max-w-6xl mx-auto p-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {videos.length === 0 && <p className="text-black font-bold italic col-span-full text-center py-10">No videos found here yet.</p>}
          ...
          {videos.map((v) => (
            <div key={v.id} className="bg-white border-4 border-black p-5 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:-translate-y-1 transition-all flex flex-col justify-between">
              <div>
                ...
                <p className="text-xs font-bold text-gray-500 line-clamp-2 mb-2">
